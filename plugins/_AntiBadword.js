...
export async function before(m, { isAdmin, isBotAdmin }) {
    ...
    if (chat.antiToxic && isAntiToxic) {
        ...
        var toxicityVerdict = [
            "ඔබ ඉතා මිත්රශීලී ය. ඔබව දැන හඳුනා ගැනීම ඉතා සාදරයෙන් පිළිගනිමු!",
             "ඔබ ඉතා විෂ සහිත නොවේ, එය විනෝදයක්ද?",
             "ඔබ විෂ සහිත බව පෙනේ. සන්සුන් වන්න!",
             "ඔච්චර විෂ වෙන්න එපා. ඔයාට විවේක ගන්න පුළුවන්!",
             "මට තවත් කියන්න දෙයක් නැහැ, ඔබ සම්පූර්ණයෙන්ම ලෝකයේ විෂ සහිත පුද්ගලයා!",
             "ඔබේ විෂ මීටරය ද 100% ට වඩා ඉහළ යයි."
        ];
